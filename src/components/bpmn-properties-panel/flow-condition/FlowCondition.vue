<template>
  <div class="panel-tab__content">
    <a-form-model :model="flowConditionForm" :label-col="labelCol" :wrapper-col="wrapperCol" size="small" @submit.native.prevent>
      ...
      <template v-if="flowConditionForm.conditionType && flowConditionForm.conditionType === 'script'">
        ...
        <a-form-model-item label="脚本" v-if="flowConditionForm.scriptType === 'inlineScript'" key="body">
          <a-textarea v-model="flowConditionForm.body" allowClear @change="updateFlowCondition" />
        </a-form-model-item>
