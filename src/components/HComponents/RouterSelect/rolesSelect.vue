...
<template>
  <section>
    ...
    <a-modal v-model="visible" :width="800" title="角色选择" @ok="handleOk" @cancel="selectedRowKeys = participants;">
      <a-table
        :columns="column"
...
export default {
  ...
  methods: {
    ...
    handleOk() {
      ...
      const JsonValue = {};
      this.$set(JsonValue, 'roleIds', this.participants);
