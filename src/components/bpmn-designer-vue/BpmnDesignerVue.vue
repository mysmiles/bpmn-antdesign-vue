  ...
  <div class="my-process-designer">
    <div class="my-process-designer__header">
      ...
      <template v-if="!$slots['control-header']">
        <a-space size="small" style="margin: 5px">
          <a-button-group key="file-control">
            <a-button :size="headerButtonSize" :type="headerButtonType" icon="folder-open" @click="$refs.refFile.click()">打开文件</a-button>
            <a-dropdown>
              <a-menu slot="overlay">
                <a-menu-item key="1">
                  <a-button :size="headerButtonSize" type="link" @click="downloadProcessAsXml()">下载为XML文件</a-button>
                </a-menu-item>
                <a-menu-item key="2">
                  <a-button :size="headerButtonSize" type="link" @click="downloadProcessAsSvg()">下载为SVG文件</a-button>
                </a-menu-item>
                <a-menu-item key="3">
                  <a-button :size="headerButtonSize" type="link" @click="downloadProcessAsBpmn()">下载为BPMN文件</a-button>
                </a-menu-item>
              </a-menu>
              <a-button :size="headerButtonSize" :type="headerButtonType" icon="download">下载文件</a-button>
            </a-dropdown>
            <a-dropdown>
              <a-menu slot="overlay">
                <a-menu-item key="1">
                  <a-button :size="headerButtonSize" type="link" @click="previewProcessXML">预览XML</a-button>
                </a-menu-item>
                <a-menu-item key="2">
                  <a-button :size="headerButtonSize" type="link" @click="previewProcessJson">预览JSON</a-button>
                </a-menu-item>
              </a-menu>
              <a-button :size="headerButtonSize" :type="headerButtonType" icon="eye">预览</a-button>
            </a-dropdown>
            <a-dropdown v-if="simulation">
              <a-menu slot="overlay">
                <a-menu-item key="1">{{ simulationStatus ? '退出模拟' : '开启模拟' }}</a-menu-item>
              </a-menu>
              <a-button :size="headerButtonSize" :type="headerButtonType" icon="caret-right" @click="processSimulation">
                模拟
              </a-button>
            </a-dropdown>
          </a-button-group>
          <a-button-group key="align-control">
            <a-tooltip title="向左对齐">
              <a-button :size="headerButtonSize" icon="align-left" @click="elementsAlign('left')" />
            </a-tooltip>
            <a-tooltip title="向右对齐">
              <a-button :size="headerButtonSize" icon="align-right" @click="elementsAlign('right')" />
            </a-tooltip>
            <a-tooltip title="向上对齐">
              <a-button :size="headerButtonSize" icon="vertical-align-top" @click="elementsAlign('top')" />
            </a-tooltip>
            <a-tooltip title="向下对齐">
              <a-button :size="headerButtonSize" icon="vertical-align-bottom" @click="elementsAlign('bottom')" />
            </a-tooltip>
            <a-tooltip title="水平居中">
              <a-button :size="headerButtonSize" icon="align-center" @click="elementsAlign('center')" />
            </a-tooltip>
            <a-tooltip title="垂直居中">
              <a-button :size="headerButtonSize" icon="vertical-align-middle" @click="elementsAlign('middle')" />
            </a-tooltip>
          </a-button-group>
          <a-button-group key="scale-control">
            ...
            <a-tooltip title="重置视图并居中">
              <a-button :size="headerButtonSize" icon="align-center" @click="processReZoom()" />
            </a-tooltip>
          </a-button-group>
...
export default {
  name: "BpmnDesignerVue",
  componentName: "BpmnDesignerVue",
  props: {
  ...
  methods: {
    ...
    async createNewDiagram(xml) {
      ...
      let newId = this.processId || `Process_${uuidV4}`;
      let newName = this.processName || `业务流程_${uuidV4}`;
